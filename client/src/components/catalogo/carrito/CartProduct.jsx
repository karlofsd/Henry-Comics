...
const CartProduct = ({name,quantity,id,price,carritoDelete, carritoGet, stock,user, newPrice,product}) =>{
    ...
    return(
        <li className='item-carrito'>
            ...
            <Product modal={modal} toggle={toggle} p={product} capitalize={capitalize} cart={true}/>
        </li>
    )
}
